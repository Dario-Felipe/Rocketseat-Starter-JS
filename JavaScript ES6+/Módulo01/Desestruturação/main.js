...
console.log(`O resultado da soma será: ${soma(1)}`);
 //Essa função retornará o valor 3, pois o valor de 'A' será 1 e o...
...
const usuario = {
  nome: "Dário",
  idade: "19",
  endereco : {          //Aqui se tem um objeto, há formas de chama-lo, são algumas:
    rua: "Rua D",
    numero: "106"
  }
}
...
function mostrar({nome, idade, endereco: { rua }}) {
